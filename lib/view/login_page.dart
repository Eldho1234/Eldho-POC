...
class _LoginPageState extends State<LoginPage> {
  ...
  void login() async{
    bool isAuthenticated=await ApiServices.login(_EmailController.text, _PasswordController.text);
    if(isAuthenticated){
...
bool isEmailVAlid(String email){
  final RegExp emailREgx=RegExp(r'^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$');
